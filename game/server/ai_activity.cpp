...
//===========================
	...
	// -----------------------------------------------------------------------
	// GMod player activity set (see ai_activity.h for the whole story).
	// Must stay in lock step with the enum block in ai_activity.h; the name is
	// what a model's pszActivityName is matched against, so a missing entry
	// here means the activity cannot be resolved by name at all.
	// -----------------------------------------------------------------------
	...
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_SWIM );
	...
	// HL2SB: ACT_GMOD_* (see ai_activity.h). Must stay in the same order as the enum.
