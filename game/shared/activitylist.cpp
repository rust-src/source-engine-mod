...
//HL2MP
	...
	// -----------------------------------------------------------------------
	// GMod player activity set (see ai_activity.h). Must stay in lock step
	// with the enum block there: under LUA_SDK this is what fills the shared
	// activity string registry AND the _E.ACTIVITY table the Lua side sees.
	// -----------------------------------------------------------------------
	...
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_SWIM );
